    ...
    return (
        <div className="">
            <Menu as="div" className="relative inline-block text-left">
                <div>
                    <Menu.Button className="group rounded-full bg-red-50 px-2 py-2 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur transition">
                        <LanguageIcon className="h-6 w-6 fill-red-50 stroke-zinc-800 transition group-hover:stroke-zinc-400"/>
                    </Menu.Button>
                </div>
                <Transition
                    as={Fragment}
                ...
                >
                    <Menu.Items className="absolute right-0 mt-2 origin-top-right divide-y divide-gray-100 rounded-md bg-red-50 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none transition">
